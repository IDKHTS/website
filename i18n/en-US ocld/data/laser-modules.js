...
export default {
  ...
  smartAirAssist: {
    ...
    imgMobSrc: 'https://ditfjx9w4x3vl.cloudfront.net/assets/laser-modules/web_Smart Air Assist..png',
    desc: `
    ...
    displays: [
      {
        ...
        desc: 'The Laser Safety Shield can reduce the laser radiation. Together with the use of Enclosure for 2.0, Artisan or Ray, it can reduce the laser hazards from Class 4 to Class 1.[2]',
  ...
  foucusLaserKickstand: {
    title: 'Focus laser with Focus Lever.',
    desc: `Alternatively, you can also focus laser with Focus Lever. Release the Focus Lever, move the toolhead down until the Focus Lever touches the material by adjusting the Z Offset on Touchscreen. In just a few steps, you can easily finish the calibration.`,
  ...
  store: {
    title: `Snapmaker 20W & 40W Laser Module with Air Assist`,
    btn: { text: 'Buy Now', link: 'https://us.snapmaker.com/products/snapmaker-2-0-quick-swap-kit' },
