...
export default {
  ...
  blockOpen: {
    h1text: 'TERMS OF USE',
    h1NextText: 'Last Updated: April 20th, 2018',
    dataOverview9: [
      {
        h2text: 'OVERVIEW',
        pData: [
          `This website is operated by Shenzhen Snapmaker Technologies Co., Ltd.. Throughout the site,
          the terms “we”, “us” and “our” refer to Shenzhen Snapmaker Technologies Co., Ltd.. offers
          ...
          It is your responsibility to check this page periodically for changes. Your continued use of or access to
          the website following the posting of any changes constitutes acceptance of those changes.`,
        ],
      },
      {
        h2text: 'SECTION 1 - ONLINE STORE TERMS',
        pData: [
      ...
      {
        h2text: 'SECTION 2 - GENERAL CONDITIONS',
        pData: [
      ...
      {
        h2text: 'SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION',
        pData: [
      ...
      {
        h2text: 'SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES',
        pData: [
      ...
      {
        h2text: 'SECTION 5 - PRODUCTS OR SERVICES (if applicable)',
        pData: [
      ...
      {
        h2text: 'SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION',
        pData: [
          ...
          orders that use the same billing and/or shipping address. In the event that we make a change
          to or cancel an order, we may attempt to notify you by contacting the e-mail and/or billing
      ...
      {
        h2text: 'SECTION 7 - OPTIONAL TOOLS',
        pData: [
          ...
          arising from or relating to your use of optional third-party tools. with access to third-party tools over which we neither monitor nor have any control nor input.`,
      ...
      {
        h2text: 'SECTION 8 - THIRD-PARTY LINKS',
        pData: [
          ...
          will not have any liability or responsibility for any third-party materials or websites, or for any other materials, products,
          ...
          the third-party's policies and practices and make sure you understand them before you engage in any transaction.
          Complaints, claims, concerns, or questions regarding third-party products should be directed to the third-party.`,
        ],
      },
      {
        h2text: 'SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS',
        pData: [
          ...
          you agree that we may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium
          any comments that you forward to us. We are and shall be under no obligation (1) to maintain any comments in confidence;
          ...
          for any comments you make and their accuracy. We take no responsibility and assume no liability for any comments posted
          by you or any third-party.`,
        ],
      },
    ],
    dataOverview10: {
      h2text: 'SECTION 10 - PERSONAL INFORMATION',
      pData: 'Your submission of personal information through the store is governed by our ',
      pDataAContent: 'Privacy Policy',
    },
    dataOverview19: [
      {
        h2text: 'SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS',
        pData: [
      ...
      {
        h2text: 'SECTION 12 - PROHIBITED USES',
        pData: [
          ...
          misleading information; (g) to upload or transmit viruses or any other type of malicious code that
          will or may be used in any way that will affect the functionality or operation of the Service or of
          any related website, other websites, or the Internet; (h) to collect or track the personal information
          of others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene or immoral
      ...
      {
        h2text: 'SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY',
        pData: [
          `We do not guarantee,
          ...
          non-infringement.`,
          `In no case shall Shenzhen Snapmaker Technologies Co., Ltd., our directors, officers, employees, affiliates, agents, contractors,
          interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental,
          punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings,
          loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability
          or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim
      ...
      {
        h2text: 'SECTION 14 - INDEMNIFICATION',
        pData: [
          `You agree to indemnify, defend and hold harmless Shenzhen Snapmaker Technologies Co., Ltd. and our parent,
          subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers,
          subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees,
          made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate
          by reference, or your violation of any law or the rights of a third-party.`,
        ],
      },
      {
        h2text: 'SECTION 15 - SEVERABILITY',
        pData: [
      ...
      {
        h2text: 'SECTION 17 - ENTIRE AGREEMENT',
        pData: [
      ...
      {
        h2text: 'SECTION 18 - GOVERNING LAW',
        pData: [
          `Disputes relating to these Terms and Conditions will be decided by a China court.
          The Terms and Conditions are governed by China law. If you live in a country other than China,
          there may be mandatory consumer protection laws which give you rights in addition to those in
          these Terms and Conditions and in China consumer protection legislation. These Terms and Conditions
          must not in any way be interpreted as placing limitations on rights of this kind.`,
        ],
      },
      {
        h2text: 'SECTION 19 - CHANGES TO TERMS OF SERVICE',
        pData: [
          'You can review the most current version of the Terms of Service at any time at this page.',
          `We reserve the right, at our sole discretion, to update, change or replace any part of
          these Terms of Service by posting updates and changes to our website. It is your responsibility
    ...
    dataOverview20: {
      h2text: 'SECTION 20 - CONTACT INFORMATION',
      pData: 'Questions about the Terms of Service should be sent to us at',
      pDataAContent: 'info@snapmaker.com',
      pDataAHref: 'mailto:info@snapmaker.com',
    },
  },
  blockPrivacy: {
    h1text: 'PRIVACY STATEMENT',
    firstSection: {
      h2text: 'SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?',
      pContent: [
    ...
    secondSection: {
      ...
      pSpecial: {
        pData: `If after you opt-in, you change your mind, you may withdraw your consent for us to contact you,
    ...
    otherSection: [
      {
        h2text: 'SECTION 3 - DISCLOSURE',
        pData: [
          'We may disclose your personal information if we are required by law to do so or if you violate our Terms of Service.',
        ],
      },
      {
        h2text: 'SECTION 4 - THIRD-PARTY SERVICES',
        pData: [
          ...
          `In particular, remember that certain providers may be located in or have facilities that are located a different jurisdiction
          ...
          then your information may become subject to the laws of the jurisdiction(s) in which that service provider or its facilities are
          located.`,
      ...
      {
        h2text: 'SECTION 5 - SECURITY',
        pData: [
          `We use certain physical, organizational, and technical safeguards that are designed to improve the integrity and security
          of information that we collect and maintain. Please be aware that no security measures are perfect or impenetrable and
          thus we cannot and do not guarantee that your information will not be accessed, viewed, disclosed, altered, or destroyed
          by breach of any of our physical, technical, or organizational safeguards.`,
        ],
      },
      {
        h2text: 'SECTION 6 - COOKIES',
        pData: [
      ...
      {
        h2text: 'SECTION 8 - AGE OF CONSENT',
        pData: [
      ...
      {
        h2text: 'SECTION 9 - CHANGES TO THIS PRIVACY POLICY',
        pData: [
  ...
  blockQestion: {
    h1text: 'QUESTIONS AND CONTACT INFORMATION',
    h1NextText: `If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint,
             or simply want more information contact our Privacy Compliance Officer at  `,
    aHref: 'mailto:info@snapmaker.com',
    aCon: 'info@snapmaker.com',
    lastPCon: '[Re: Privacy Compliance Officer]',
    section1: {
      h2text: 'Refunds (if applicable)',
      pContent: [
        `We provide 30 days money back guarantee since the date of placing the order and before the date when the product is shipped.
                If 30 days have gone by since your purchase or your product is shipped, unfortunately we can’t offer you a refund.`,
        'If you have a refund request, please send an email to support@snapmaker.com.',
        `If your request are approved, then your refund will be processed, and a credit will automatically be applied to your credit
                 card or original method of payment, within a certain amount of days.`,
      ],
    },
    section2: {
      h2text: 'Late or missing refunds (if applicable)',
      pContent: [
      ...
      pHaveA: {
        pContent: 'If you’ve done all of this and you still have not received your refund yet, please contact us at',
        aHref: 'mailto:support@snapmaker.com',
        aCon: 'support@snapmaker.com',
      },
    },
    section3: {
      h2text: 'Sale items (if applicable)',
      pContent: [
    ...
    section4: {
      h2text: 'Returns',
      pHaveA: {
        pContent: `Returning the product (the whole machine instead of the warranted parts) is not acceptable once the product is shipped.
                We can’t offer you a refund or exchange as a result. If you run into a problem that you can’t solve, please contact our
    ...
    section5: {
      h2text: 'Exchanges (if applicable)',
      pHaveA: {
        pContent: `We only replace items if they are defective or damaged. If you need to exchange it for the same item,
                send us an email at `,
        aHref: 'mailto:support@snapmaker.com',
        aCon: 'support@snapmaker.com',
      },
    ...
    section7: {
      ...
      pContent: [
        ...
        `If you are shipping an item over $75, you should consider using a trackable shipping service or purchasing
                 shipping insura nce. We don’t guarantee that we will receive your returned item.`,
      ],
    },
  },
};
